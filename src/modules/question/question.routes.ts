...
import questionValidator, { questionIdValidation } from "./interface/question.validator.js";
...
export default (app: Application) => {
  ...
  app.put(`${route}/:id`, bodyParser, validateParams(quizIdValidation) ,validateBody(questionValidator), controllers.putQuestion);
}